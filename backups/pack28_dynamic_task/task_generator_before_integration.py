...
class TaskGenerator:
    ...
    def generate_enterprise_tasks(self, request):
        ...
        if any(
            ...
            from app.ai.autonomous.models import Task


            tasks=[
                Task(
                    name="design_enterprise_architecture",
                    priority=10
                ),

                Task(
                    name="create_erp_modules",
                    priority=9
                ),

                Task(
                    name="build_tenant_system",
                    priority=8
                ),

                Task(
                    name="generate_enterprise_release",
                    priority=7
                ),
