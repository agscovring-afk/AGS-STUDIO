...
from app.ai.intelligence.task_engine.dynamic_task_engine import DynamicTaskEngine
...
class TaskGenerator:
    ...
    def __init__(self, context=None):
        ...
        self.dynamic_engine = DynamicTaskEngine()
    ...
    def generate(self, request: str):
        ...
        dynamic_tasks = self.dynamic_engine.generate(request)
        ...
        if dynamic_tasks:
            return [
                ...
                for name, description, priority in dynamic_tasks
            ]
    ...
    def generate_enterprise_tasks(self, request):
