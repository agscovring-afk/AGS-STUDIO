...
import { XS, BLOCS, DMIN, DCREUX, DPETIT, DMAX, FASCIA, GC, PBW, PBH, HSP, DALLE,
...
g.push(coupe(1470, 610, DMAX, '2 · COUPE A-A — AU GRAND LOBE', 58, true));
g.push(coupe(1470, 1128, DPETIT, '3 · COUPE B-B — AU PETIT LOBE', 790, false));
...
// ===========================================================================
{
  ...
  // reperes de coupe
  for (const [m, lab] of [[11.61, 'A'], [13.57, 'B']]) {
