...
${foot([
  ...
  ['Ce qui est contraint', 'Le tracé retenu sort à 1,80 m au grand lobe, revient à 0,79 m au creux médian, ressort à 1,10 m au petit lobe, pour un développé de ' + developpe().toFixed(2) + ' ml par balcon.'],
