...
const LEG = [
  ...
  ['Brise-vue aluminium', 'Il n’est pas en façade : il sépare les deux balcons du vide central. Lames RAL 7024 sur l’axe, du fond de la niche au nu, du R+2 à la toiture — chaque voisin est chez lui.'],
  ...
  ['Balcons du vide central', 'Le vide de 1,80 m creusé de 1,50 m porte deux balcons côte à côte, un par logement — 0,84 × 1,50 m chacun, porte-fenêtre de 0,90 m au fond, garde-corps droit au nu.'],
